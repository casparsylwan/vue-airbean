<template>
  <div class="about">
    ...
    <div class="photo">
      <img src='../assets/svg/eva-cortado.jpg' alt="photo on owner">
      <h3>Eva Cortado</h3>
      <h4>Vd grundare</h4>
    </div>
    <imgBottom></imgBottom>
